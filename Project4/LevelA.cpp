...
ENEMY_FILEPATH[] = "assets/bee.png",
FONTSHEET_FILEPATH[] = "assets/font1.png";

GLuint g_font_texture_id1;
...
unsigned int LEVELA_DATA[] =
{
    ...
    25,23,23,23,23,23,23,23,23,23,23,23,23,23,
    25,23,23,23,23,23,23,23,23,23,23,23,23,23,
    25,23,23,23,23,22,22,22,23,23,23,23,23,23,
    25,23,23,23,23,23,23,23,23,23,23,23,22,22,
    25,22,22,22,22,22,22,22,22,22,22,22,25,25,
...
{   
    g_font_texture_id1 = Utility::load_texture(FONTSHEET_FILEPATH);

    GLuint map_texture_id = Utility::load_texture("assets/grasssheet.png");
    m_game_state.map = new Map(LEVEL_WIDTH, LEVEL_HEIGHT, LEVELA_DATA, map_texture_id, 1.0f, 6, 7);
...
void LevelA::update(float delta_time)
{
    ...
    if (m_game_state.player->check_collision(m_game_state.enemies))
    {
...
void LevelA::render(ShaderProgram *g_shader_program, int life)
{
    ...
    Utility::draw_text(g_shader_program, g_font_texture_id1, "Level " + std::to_string(LEVEL_NUM), 0.3f, 0.05f,
        glm::vec3(0.1f+offset, -0.3f, 0.0f));

    Utility::draw_text(g_shader_program, g_font_texture_id1, "Life " + std::to_string(life), 0.3f, 0.05f,
        glm::vec3(8.0f+offset, -0.3f, 0.0f));
    
    if (life == 0) {
        Utility::draw_text(g_shader_program, g_font_texture_id1, "You Lose", 0.5f, 0.05f,
